    ...
    return (
        <div className="fixed-bottom container mx-auto px-0 w-auto h-10">
            <div className="row justify-content-between">
                <a href="https://www.freepik.com/free-photo/colleagues-giving-fist-bump_3532664.htm#page=2&query=communication&position=23&from_view=search&track=sph" className='copyright text-decoration-none text-black pe-none col-6 mx-0 align-bottom'>Image by rawpixel.com on Freepik</a> 
